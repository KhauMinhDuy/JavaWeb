            ...
            <ul class="nav ace-nav">
                <li class="grey dropdown-modal">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <em class="ace-icon fa fa-tasks"></em>
                        <span class="badge badge-grey">4</span>
                    </a>

                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        <li class="dropdown-header">
                            <em class="ace-icon fa fa-check"></em>
                            4 Tasks to complete
                        </li>
                ...
                <li class="purple dropdown-modal">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <em class="ace-icon fa fa-bell icon-animated-bell"></em>
                        <span class="badge badge-important">8</span>
                    </a>

                    <ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
                        <li class="dropdown-header">
                            <em class="ace-icon fa fa-exclamation-triangle"></em>
                            8 Notifications
                        </li>
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar navbar-pink">
                                    ...
                                    <a href="#">
                                        <div class="clearfix">
													<span class="pull-left">
														<em class="btn btn-xs no-hover btn-pink fa fa-comment"></em>
														New Comments
													</span>
                                ...
                                <li>
                                    <a href="#">
                                        <em class="btn btn-xs btn-primary fa fa-user"></em>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="clearfix">
													<span class="pull-left">
														<em class="btn btn-xs no-hover btn-success fa fa-shopping-cart"></em>
														New Orders
													</span>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="clearfix">
													<span class="pull-left">
														<em class="btn btn-xs no-hover btn-info fa fa-twitter"></em>
														Followers
													</span>
                ...
                <li class="green dropdown-modal">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <em class="ace-icon fa fa-envelope icon-animated-vertical"></em>
                        <span class="badge badge-success">5</span>
                    </a>

                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        <li class="dropdown-header">
                            <em class="ace-icon fa fa-envelope-o"></em>
                            5 Messages
                        </li>
                ...
                <li class="light-blue dropdown-modal">
                    ...
                    <ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="#">
                                <em class="ace-icon fa fa-power-off"></em>
                                Logout
                            </a>
                        </li>
                    </ul>
